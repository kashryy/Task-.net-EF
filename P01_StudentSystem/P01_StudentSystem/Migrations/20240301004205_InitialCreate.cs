        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredOn = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "good course", "22-2-2024", "database", "3000LE", "22-2-2023" });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "StudentId", "Birthday", "Name", "PhoneNumber", "RegisteredOn" },
                values: new object[] { 1, "20-2-2001", "khalid", "200000", "2:30" });

            migrationBuilder.InsertData(
                table: "Homeworks",
                columns: new[] { "HomeworkId", "Content", "CourseId", "StudentId", "SubmissionTime" },
                values: new object[] { 1, "data", 1, 1, "3:30" });

            migrationBuilder.InsertData(
                table: "Resources",
                columns: new[] { "ResourceId", "CourseId", "EndDate", "Name", "Url" },
                values: new object[] { 1, 1, "2022, 1, 1", "anything", "https://learn.microsoft.com/en-us/ef/core/modeling/data-seeding" });
